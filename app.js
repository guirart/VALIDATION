...
const CHECKLIST_15 = [
  ...
  {
  point:7,
  title:'Prorrogação de 30 dias',
  legal_reference:'art. 4º',
  description:'Verificar literalmente os requisitos do art. 4º, inclusive a situação de ADIMPLÊNCIA na data prevista pela norma, o vencimento da operação e o pedido de contratação da nova linha.',
  resolve:'Conferir documentalmente a situação de ADIMPLÊNCIA na data exigida pelo art. 4º, bem como o vencimento da obrigação e os demais requisitos legais. Não presumir adimplência ou inadimplência. Se faltar prova, registrar como não comprovado e solicitar extrato ou declaração da instituição financeira.'
},
