...
import { finalizeImport } from '../lib/stagedTestImport.js';
export default async function handler(req,res){
  ...
  try{const out=await finalizeImport({principal,body:await readJson(req)});return json(res,out.statusCode,out.body);}
