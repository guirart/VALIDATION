...
export function createVeredictaMcpServer(){
  const server=new McpServer(
    {name:'veredicta',version:'3.14.3'},
    {instructions:'Antes da primeira análise, consulte o status e carregue as fontes jurídicas do Veredicta. Use somente citações literais dessas fontes e do contrato recuperado. Faça análise e auditoria independentes dos 15 pontos e envie somente a análise completa. A revisão humana é sempre obrigatória.'}
  );
